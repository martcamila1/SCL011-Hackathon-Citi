...
const DebitCard=()=>{
  return(
    ...
    <div className="credit-card-container">
      <header>
        <svg width="43" height="34" viewBox="0 0 65 51" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <body className="credit-card-body">
        <h3 className="h3">2. Ingresa tus datos</h3>
        <div className="inputs-container">
          <label>
            Banco
            <input className="input" type="text" placeholder="Busca tu banco"/>
          </label>
          <label>
            Nº Tarjeta
            <input className="input" type="text" placeholder="0000-0000-0000-0000"/>
          </label>
          <label>
            Fecha Vencimiento
        ...
        <div className="action-btns">
          ...
          <Link to="/CreditCardResumen"><button className="btn-inscribir">Inscribir</button></Link>
        </div>
      </body>
    </div>
  </div>  
