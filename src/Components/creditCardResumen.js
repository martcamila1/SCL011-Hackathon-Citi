  ...
  return(
    ...
    <div className="credit-card-container">
      ...
      <body className="credit-card-body">
          ...
          <hr className="line"/>
            <div className="info-resumen-container">
              <div className="info-resumen">
                ...
                <p>Banco Santander</p>
                <p className="bold-title gap">Fecha de Vencimiento</p>
                <p>20/03</p>
              </div>
              <div className="info-resumen">
                <p className="bold-title">Tipo de cuenta</p>
                <p>Tarjeta Crédito</p>
                <p className="bold-title gap">Código de verificación</p>
                <p>123</p>
              </div>
              <div className="info-resumen">
        ...
        <Link to="/CreditCard"><button className="btn-volver">Volver</button></Link>
...
export default CreditCardResumen